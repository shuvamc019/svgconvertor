...
export class BinaryImageConverter {
    ...
    */
    static new_with_string(params) {
        ...
        var ret = wasm.binaryimageconverter_new_with_string(ptr0, len0);
    ...
    */
    tick() {
        var ret = wasm.binaryimageconverter_tick(this.ptr);
        return ret !== 0;
    }
    /**
    * @returns {number}
    */
    progress() {
        var ret = wasm.binaryimageconverter_progress(this.ptr);
        return ret >>> 0;
    }
}
/**
...
export class ColorImageConverter {
    ...
    */
    static new_with_string(params) {
        var ptr0 = passStringToWasm0(params, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        var ret = wasm.colorimageconverter_new_with_string(ptr0, len0);
    ...
    */
    tick() {
        var ret = wasm.colorimageconverter_tick(this.ptr);
        return ret !== 0;
    }
    /**
    * @returns {number}
    */
    progress() {
        var ret = wasm.colorimageconverter_progress(this.ptr);
        return ret;
    }
}
...
async function init(input) {
    ...
    imports.wbg.__wbg_prepend_58048c0095e73010 = function() { return handleError(function (arg0, arg1) {
